...
namespace ptlogin
{
    public partial class Statusst : Form
    {
       ...
       // List<TextBox> name = new List<TextBox>();
        ...
        private void Statusst_Load(object sender, EventArgs e)
        {
            ...
            sqlCmd.CommandText = "SELECT fgd,mttv,grn1,mis,mttp,cpr,cpo,ttv,grn2,stock,invoice FROM fgd where  mttv='1' or grn1='1' or mis='1' or mttp='1' or cpr='1' or cpo='1' or ttv='1' or grn2='1' or stock='1' or invoice='1' ";
