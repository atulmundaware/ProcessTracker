...
namespace ptlogin
{
    public partial class Statuspro : Form
    {
       // List<TextBox> name = new List<TextBox>();
        ...
        private void Statuspro_Load(object sender, EventArgs e)
        {
            ...
            sqlCmd.CommandText = "SELECT fgd,mcp,production,marking,pp,stock FROM fgd where mcp='1' or production='1' or marking='1' or pp='1' or stock='1' ";
           // sqlCmd.CommandText = "SELECT fgd,co,pr,mttv,cpr,swp,mcp,pp,stock FROM fgd where  co='1' or pr='1' or mttv='1' or cpr='1' or swp='1' or mcp='1' or pp='1' or stock='1' ";
            ...
            try
            {
                ...
                while (read.Read())
                {
                    ...
                    if (read[4].Equals(eq))
                    {
                        la2[i].Text = "PRODUCTION PUNCHING";
